...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post agencies_url, params: { agency: { acc_active: @agency.acc_active, email: @agency.email, last_in: @agency.last_in, name: @agency.name, pass_active: @agency.pass_active, password_digest: @agency.password_digest } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { acc_active: @agency.acc_active, email: @agency.email, last_in: @agency.last_in, name: @agency.name, pass_active: @agency.pass_active, password_digest: @agency.password_digest } }
