...
class ContractorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contractor" do
    assert_difference('Contractor.count') do
      post contractors_url, params: { contractor: { acc_active: @contractor.acc_active, email: @contractor.email, last_in: @contractor.last_in, name: @contractor.name, pass_active: @contractor.pass_active, password_digest: @contractor.password_digest, surname: @contractor.surname } }
    end
  ...
  test "should update contractor" do
    patch contractor_url(@contractor), params: { contractor: { acc_active: @contractor.acc_active, email: @contractor.email, last_in: @contractor.last_in, name: @contractor.name, pass_active: @contractor.pass_active, password_digest: @contractor.password_digest, surname: @contractor.surname } }
